...
public class MenuItemTest {
    ...
    void deveLancarExcecaoSemNome() {
        // Arrange
        MenuItem invalid = MenuItem.builder().price(10.0).build();
    ...
    void deveLancarExcecaoPrecoInvalido() {
        // Arrange
        MenuItem invalid = MenuItem.builder().name("Item").price(0.0).build();
    ...
    void deveLancarExcecaoSemRestaurante() {
        // Arrange
        MenuItem invalid = MenuItem.builder().name("Item").price(10.0).build();
